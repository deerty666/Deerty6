...
function renderFavoritesShortcut(){
    ...
    favCard.innerHTML = `<img src="logo-bg.webp" alt="المفضلات" loading="lazy"><div class="sec-name">المفضلات ❤️</div>`;
    favCard.onclick = () => {
...
الحين عندي مشكله السله لا تظهر المنتجات ولا زر مسح السله وعندي مشكله اختيار الإضافات في المنتجات لا تظهر
