...
const BRANCH_CONFIG = {
    'branch1': { 
        ...
        name: 'الرياض', // اسم الفرع في الرسائل وعنوان الصفحة
        deliveryFee: 5,
    },
    'branch2': {
...
/* ====== بيانات المنيو - تم إضافة availableIn و branchDiscounts ====== */
const menuData = [
  // 1. القسم الجديد: الكل
  { 
    section:"الكل", 
  ...
  { 
    ...
    items:[
      // هذه الوجبة متوفرة في فرع الرياض ومكة فقط (branch1 و branch3)
  ...
  { 
    ...
    items:[
      // متوفر في فرع جدة ومكة فقط (branch2 و branch3)
  ...
  { 
    ...
    items:[
      // ⭐️ خصم 40 ريال لفرع الرياض (branch1) فقط. السعر الأساسي يبقى 50 للآخرين.
      {
          id:"mg1", 
          img:"/Dirty55/mg.jpg", 
          name:"دجاج مضغوط حبه", 
...
/* ====== Render sections - ⭐️ تم التعديل لتصفية الأقسام حسب الفرع ====== */
function renderSections(){
  sectionsEl.innerHTML = '';
  menuData.forEach((sec,idx)=>{
    
    // ⭐️ منطق إخفاء القسم بالكامل 
    ...
    card.innerHTML = `
      ...
      <div class="sec-name">فرع ${sec.section === "الكل" ? currentBranch.name : sec.section}</div>
    `;
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    // تأكد من أن هذا المسار صحيح على GitHub Pages
